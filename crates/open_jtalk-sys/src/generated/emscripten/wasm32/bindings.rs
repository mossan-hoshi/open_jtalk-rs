...
const _: () = {
    ...
    ][::std::mem::size_of::<mecab_dictionary_info_t>() - 32usize];
    [
        "Alignment of mecab_dictionary_info_t",
    ][::std::mem::align_of::<mecab_dictionary_info_t>() - 4usize];
    [
    ...
    ][::std::mem::offset_of!(mecab_dictionary_info_t, charset) - 4usize];
    [
        "Offset of field: mecab_dictionary_info_t::size",
    ][::std::mem::offset_of!(mecab_dictionary_info_t, size) - 8usize];
    [
        "Offset of field: mecab_dictionary_info_t::type_",
    ][::std::mem::offset_of!(mecab_dictionary_info_t, type_) - 12usize];
    [
        "Offset of field: mecab_dictionary_info_t::lsize",
    ][::std::mem::offset_of!(mecab_dictionary_info_t, lsize) - 16usize];
    [
        "Offset of field: mecab_dictionary_info_t::rsize",
    ][::std::mem::offset_of!(mecab_dictionary_info_t, rsize) - 20usize];
    [
        "Offset of field: mecab_dictionary_info_t::version",
    ][::std::mem::offset_of!(mecab_dictionary_info_t, version) - 24usize];
    [
        "Offset of field: mecab_dictionary_info_t::next",
    ][::std::mem::offset_of!(mecab_dictionary_info_t, next) - 28usize];
};
/// Path structure
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mecab_path_t"][::std::mem::size_of::<mecab_path_t>() - 24usize];
    ["Alignment of mecab_path_t"][::std::mem::align_of::<mecab_path_t>() - 4usize];
    [
        "Offset of field: mecab_path_t::rnode",
    ][::std::mem::offset_of!(mecab_path_t, rnode) - 0usize];
    [
        "Offset of field: mecab_path_t::rnext",
    ][::std::mem::offset_of!(mecab_path_t, rnext) - 4usize];
    [
        "Offset of field: mecab_path_t::lnode",
    ][::std::mem::offset_of!(mecab_path_t, lnode) - 8usize];
    [
        "Offset of field: mecab_path_t::lnext",
    ][::std::mem::offset_of!(mecab_path_t, lnext) - 12usize];
    [
        "Offset of field: mecab_path_t::cost",
    ][::std::mem::offset_of!(mecab_path_t, cost) - 16usize];
    [
        "Offset of field: mecab_path_t::prob",
    ][::std::mem::offset_of!(mecab_path_t, prob) - 20usize];
};
/// Node structure
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mecab_node_t"][::std::mem::size_of::<mecab_node_t>() - 72usize];
    ["Alignment of mecab_node_t"][::std::mem::align_of::<mecab_node_t>() - 4usize];
    [
        "Offset of field: mecab_node_t::prev",
    ][::std::mem::offset_of!(mecab_node_t, prev) - 0usize];
    [
        "Offset of field: mecab_node_t::next",
    ][::std::mem::offset_of!(mecab_node_t, next) - 4usize];
    [
        "Offset of field: mecab_node_t::enext",
    ][::std::mem::offset_of!(mecab_node_t, enext) - 8usize];
    [
        "Offset of field: mecab_node_t::bnext",
    ][::std::mem::offset_of!(mecab_node_t, bnext) - 12usize];
    [
        "Offset of field: mecab_node_t::rpath",
    ][::std::mem::offset_of!(mecab_node_t, rpath) - 16usize];
    [
        "Offset of field: mecab_node_t::lpath",
    ][::std::mem::offset_of!(mecab_node_t, lpath) - 20usize];
    [
        "Offset of field: mecab_node_t::surface",
    ][::std::mem::offset_of!(mecab_node_t, surface) - 24usize];
    [
        "Offset of field: mecab_node_t::feature",
    ][::std::mem::offset_of!(mecab_node_t, feature) - 28usize];
    [
        "Offset of field: mecab_node_t::id",
    ][::std::mem::offset_of!(mecab_node_t, id) - 32usize];
    [
        "Offset of field: mecab_node_t::length",
    ][::std::mem::offset_of!(mecab_node_t, length) - 36usize];
    [
        "Offset of field: mecab_node_t::rlength",
    ][::std::mem::offset_of!(mecab_node_t, rlength) - 38usize];
    [
        "Offset of field: mecab_node_t::rcAttr",
    ][::std::mem::offset_of!(mecab_node_t, rcAttr) - 40usize];
    [
        "Offset of field: mecab_node_t::lcAttr",
    ][::std::mem::offset_of!(mecab_node_t, lcAttr) - 42usize];
    [
        "Offset of field: mecab_node_t::posid",
    ][::std::mem::offset_of!(mecab_node_t, posid) - 44usize];
    [
        "Offset of field: mecab_node_t::char_type",
    ][::std::mem::offset_of!(mecab_node_t, char_type) - 46usize];
    [
        "Offset of field: mecab_node_t::stat",
    ][::std::mem::offset_of!(mecab_node_t, stat) - 47usize];
    [
    ...
    ][::std::mem::offset_of!(mecab_node_t, beta) - 56usize];
    [
        "Offset of field: mecab_node_t::prob",
    ][::std::mem::offset_of!(mecab_node_t, prob) - 60usize];
    [
        "Offset of field: mecab_node_t::wcost",
    ][::std::mem::offset_of!(mecab_node_t, wcost) - 64usize];
    [
        "Offset of field: mecab_node_t::cost",
    ][::std::mem::offset_of!(mecab_node_t, cost) - 68usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MeCab_Lattice"][::std::mem::size_of::<MeCab_Lattice>() - 4usize];
    ["Alignment of MeCab_Lattice"][::std::mem::align_of::<MeCab_Lattice>() - 4usize];
};
extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MeCab_Model"][::std::mem::size_of::<MeCab_Model>() - 4usize];
    ["Alignment of MeCab_Model"][::std::mem::align_of::<MeCab_Model>() - 4usize];
};
extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MeCab_Tagger"][::std::mem::size_of::<MeCab_Tagger>() - 4usize];
    ["Alignment of MeCab_Tagger"][::std::mem::align_of::<MeCab_Tagger>() - 4usize];
};
extern "C" {
    /** Handy static method.
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _Mecab"][::std::mem::size_of::<_Mecab>() - 20usize];
    ["Alignment of _Mecab"][::std::mem::align_of::<_Mecab>() - 4usize];
    [
        "Offset of field: _Mecab::feature",
    ][::std::mem::offset_of!(_Mecab, feature) - 0usize];
    ["Offset of field: _Mecab::size"][::std::mem::offset_of!(_Mecab, size) - 4usize];
    ["Offset of field: _Mecab::model"][::std::mem::offset_of!(_Mecab, model) - 8usize];
    [
        "Offset of field: _Mecab::tagger",
    ][::std::mem::offset_of!(_Mecab, tagger) - 12usize];
    [
        "Offset of field: _Mecab::lattice",
    ][::std::mem::offset_of!(_Mecab, lattice) - 16usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _NJDNode"][::std::mem::size_of::<_NJDNode>() - 64usize];
    ["Alignment of _NJDNode"][::std::mem::align_of::<_NJDNode>() - 4usize];
    [
        "Offset of field: _NJDNode::string",
    ][::std::mem::offset_of!(_NJDNode, string) - 0usize];
    ["Offset of field: _NJDNode::pos"][::std::mem::offset_of!(_NJDNode, pos) - 4usize];
    [
        "Offset of field: _NJDNode::pos_group1",
    ][::std::mem::offset_of!(_NJDNode, pos_group1) - 8usize];
    [
        "Offset of field: _NJDNode::pos_group2",
    ][::std::mem::offset_of!(_NJDNode, pos_group2) - 12usize];
    [
        "Offset of field: _NJDNode::pos_group3",
    ][::std::mem::offset_of!(_NJDNode, pos_group3) - 16usize];
    [
        "Offset of field: _NJDNode::ctype",
    ][::std::mem::offset_of!(_NJDNode, ctype) - 20usize];
    [
        "Offset of field: _NJDNode::cform",
    ][::std::mem::offset_of!(_NJDNode, cform) - 24usize];
    [
        "Offset of field: _NJDNode::orig",
    ][::std::mem::offset_of!(_NJDNode, orig) - 28usize];
    [
        "Offset of field: _NJDNode::read",
    ][::std::mem::offset_of!(_NJDNode, read) - 32usize];
    [
        "Offset of field: _NJDNode::pron",
    ][::std::mem::offset_of!(_NJDNode, pron) - 36usize];
    ["Offset of field: _NJDNode::acc"][::std::mem::offset_of!(_NJDNode, acc) - 40usize];
    [
        "Offset of field: _NJDNode::mora_size",
    ][::std::mem::offset_of!(_NJDNode, mora_size) - 44usize];
    [
        "Offset of field: _NJDNode::chain_rule",
    ][::std::mem::offset_of!(_NJDNode, chain_rule) - 48usize];
    [
        "Offset of field: _NJDNode::chain_flag",
    ][::std::mem::offset_of!(_NJDNode, chain_flag) - 52usize];
    [
        "Offset of field: _NJDNode::prev",
    ][::std::mem::offset_of!(_NJDNode, prev) - 56usize];
    [
        "Offset of field: _NJDNode::next",
    ][::std::mem::offset_of!(_NJDNode, next) - 60usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _NJD"][::std::mem::size_of::<_NJD>() - 8usize];
    ["Alignment of _NJD"][::std::mem::align_of::<_NJD>() - 4usize];
    ["Offset of field: _NJD::head"][::std::mem::offset_of!(_NJD, head) - 0usize];
    ["Offset of field: _NJD::tail"][::std::mem::offset_of!(_NJD, tail) - 4usize];
};
pub type NJD = _NJD;
extern "C" {
...
const _: () = {
    ...
    ][::std::mem::size_of::<_JPCommonLabelPhoneme>() - 16usize];
    [
        "Alignment of _JPCommonLabelPhoneme",
    ][::std::mem::align_of::<_JPCommonLabelPhoneme>() - 4usize];
    [
    ...
    ][::std::mem::offset_of!(_JPCommonLabelPhoneme, prev) - 4usize];
    [
        "Offset of field: _JPCommonLabelPhoneme::next",
    ][::std::mem::offset_of!(_JPCommonLabelPhoneme, next) - 8usize];
    [
        "Offset of field: _JPCommonLabelPhoneme::up",
    ][::std::mem::offset_of!(_JPCommonLabelPhoneme, up) - 12usize];
};
...
const _: () = {
    ...
    ][::std::mem::size_of::<_JPCommonLabelMora>() - 24usize];
    [
        "Alignment of _JPCommonLabelMora",
    ][::std::mem::align_of::<_JPCommonLabelMora>() - 4usize];
    [
    ...
    ][::std::mem::offset_of!(_JPCommonLabelMora, head) - 4usize];
    [
        "Offset of field: _JPCommonLabelMora::tail",
    ][::std::mem::offset_of!(_JPCommonLabelMora, tail) - 8usize];
    [
        "Offset of field: _JPCommonLabelMora::prev",
    ][::std::mem::offset_of!(_JPCommonLabelMora, prev) - 12usize];
    [
        "Offset of field: _JPCommonLabelMora::next",
    ][::std::mem::offset_of!(_JPCommonLabelMora, next) - 16usize];
    [
        "Offset of field: _JPCommonLabelMora::up",
    ][::std::mem::offset_of!(_JPCommonLabelMora, up) - 20usize];
};
...
const _: () = {
    ...
    ][::std::mem::size_of::<_JPCommonLabelWord>() - 36usize];
    [
        "Alignment of _JPCommonLabelWord",
    ][::std::mem::align_of::<_JPCommonLabelWord>() - 4usize];
    [
    ...
    ][::std::mem::offset_of!(_JPCommonLabelWord, pos) - 4usize];
    [
        "Offset of field: _JPCommonLabelWord::ctype",
    ][::std::mem::offset_of!(_JPCommonLabelWord, ctype) - 8usize];
    [
        "Offset of field: _JPCommonLabelWord::cform",
    ][::std::mem::offset_of!(_JPCommonLabelWord, cform) - 12usize];
    [
        "Offset of field: _JPCommonLabelWord::head",
    ][::std::mem::offset_of!(_JPCommonLabelWord, head) - 16usize];
    [
        "Offset of field: _JPCommonLabelWord::tail",
    ][::std::mem::offset_of!(_JPCommonLabelWord, tail) - 20usize];
    [
        "Offset of field: _JPCommonLabelWord::prev",
    ][::std::mem::offset_of!(_JPCommonLabelWord, prev) - 24usize];
    [
        "Offset of field: _JPCommonLabelWord::next",
    ][::std::mem::offset_of!(_JPCommonLabelWord, next) - 28usize];
    [
        "Offset of field: _JPCommonLabelWord::up",
    ][::std::mem::offset_of!(_JPCommonLabelWord, up) - 32usize];
};
...
const _: () = {
    ...
    ][::std::mem::size_of::<_JPCommonLabelBreathGroup>() - 16usize];
    [
        "Alignment of _JPCommonLabelBreathGroup",
    ][::std::mem::align_of::<_JPCommonLabelBreathGroup>() - 4usize];
    [
    ...
    ][::std::mem::offset_of!(_JPCommonLabelBreathGroup, tail) - 4usize];
    [
        "Offset of field: _JPCommonLabelBreathGroup::prev",
    ][::std::mem::offset_of!(_JPCommonLabelBreathGroup, prev) - 8usize];
    [
        "Offset of field: _JPCommonLabelBreathGroup::next",
    ][::std::mem::offset_of!(_JPCommonLabelBreathGroup, next) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _JPCommonNode"][::std::mem::size_of::<_JPCommonNode>() - 32usize];
    ["Alignment of _JPCommonNode"][::std::mem::align_of::<_JPCommonNode>() - 4usize];
    [
        "Offset of field: _JPCommonNode::pron",
    ][::std::mem::offset_of!(_JPCommonNode, pron) - 0usize];
    [
        "Offset of field: _JPCommonNode::pos",
    ][::std::mem::offset_of!(_JPCommonNode, pos) - 4usize];
    [
        "Offset of field: _JPCommonNode::ctype",
    ][::std::mem::offset_of!(_JPCommonNode, ctype) - 8usize];
    [
        "Offset of field: _JPCommonNode::cform",
    ][::std::mem::offset_of!(_JPCommonNode, cform) - 12usize];
    [
        "Offset of field: _JPCommonNode::acc",
    ][::std::mem::offset_of!(_JPCommonNode, acc) - 16usize];
    [
        "Offset of field: _JPCommonNode::chain_flag",
    ][::std::mem::offset_of!(_JPCommonNode, chain_flag) - 20usize];
    [
        "Offset of field: _JPCommonNode::prev",
    ][::std::mem::offset_of!(_JPCommonNode, prev) - 24usize];
    [
        "Offset of field: _JPCommonNode::next",
    ][::std::mem::offset_of!(_JPCommonNode, next) - 28usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _JPCommon"][::std::mem::size_of::<_JPCommon>() - 12usize];
    ["Alignment of _JPCommon"][::std::mem::align_of::<_JPCommon>() - 4usize];
    [
        "Offset of field: _JPCommon::head",
    ][::std::mem::offset_of!(_JPCommon, head) - 0usize];
    [
        "Offset of field: _JPCommon::tail",
    ][::std::mem::offset_of!(_JPCommon, tail) - 4usize];
    [
        "Offset of field: _JPCommon::label",
    ][::std::mem::offset_of!(_JPCommon, label) - 8usize];
};
